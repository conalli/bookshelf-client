  ...
  return (
    <nav className="flex flex-row gap-2 justify-between py-2">
      ...
      <div className="flex flex-row gap-1 items-center mx-4 divide-x divide-bk-blue dark:divide-bk-orange  bg-white dark:bg-neutral-900 shadow-lg rounded-md">
        <Link href="/#about">
          <a className="text-sm py-2 px-4 ml-1 hover:text-bk-blue hover:dark:text-orange-300 rounded-md">
            About
          </a>
        </Link>
        <Link href="/dashboard">
          <a className="text-sm py-2 px-4 hover:text-bk-blue hover:dark:text-orange-300">
            Dashboard
          </a>
        </Link>
