...
const GoogleSignInButton: React.FC<{ authType: SignInFormVariant }> = ({
  ...
  return (
    <button className="flex justify-center bg-gray-100 dark:bg-white dark:text-black px-5 py-2 hover:opacity-90 rounded shadow-md">
      <Link className="flex gap-2 items-center justify-center" href={href}>
        <GoogleIcon />
